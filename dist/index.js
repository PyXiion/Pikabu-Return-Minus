...
`;
    ...
    (function (Nodes) {
        ...
        (function (UserRating) {
             ...
             */
            async function showReasonDialog(uid, vote) {
                ...
                const cancelButton = createElementWithClass("button", "rpm-modal-button");
                cancelButton.innerText = "Отмена";
                cancelButton.addEventListener("click", () => overlay.remove());
                const submitButton = createElementWithClass("button", "rpm-modal-button", "button_success");
            ...
            UserRating.showReasonDialog = showReasonDialog;
